...
class Contact(db.Model):
    ...
    )  # Allow null if added before name known
    ...
    messages = db.relationship(
        "Message", backref="contact", lazy=True, foreign_keys="Message.phone_number"
    )
...
class Message(db.Model):
    ...
    )  # Comma-separated relative paths (e.g., uploads/img1.jpg,uploads/img2.png)
    # --- <<< END OF ADDITION >>> ---
